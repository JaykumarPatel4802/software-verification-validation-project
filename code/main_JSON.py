from Text2SQL_JSON import Text2SQL_JSON, Model
...
# for m in Model:
#     if m not in [Model.DeepSeek]:
#         model = Text2SQL_JSON(model=m, is_agentic=False)
...
# for m in Model:
#     if m not in [Model.DeepSeek]:
#         model = Text2SQL_JSON(model=m, is_agentic=True)
#         print("Running Model: ", m)
#         sqlite_helper = SQLiteHelper()
#         for i in range(3):
...
print("Running Agentic")
for m in Model:
    if m not in [Model.DeepSeek, Model.ChatGPT, Model.Llama, Model.Claude]:
        model = Text2SQL_JSON(model=m, is_agentic=True)
        print("Running Model: ", m)
        sqlite_helper = SQLiteHelper()
        for i in range(3):
