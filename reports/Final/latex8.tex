...
Temperature controls the degree of randomness in the text generated by LLMs during inference \cite{temperature}. The default temperature for Claude 3.5 Sonnet is 1.0, which represents the maximum level of randomness. For GPT-4o mini, the default temperature is 0.7; however, in this study, we increase it to 1.0 to enable greater diversity in the SQL queries generated across three runs, with the hope of improving the chances of obtaining a correct result. For Llama 3.1 8B, we keep the default lower temperature, as smaller models are generally more prone to hallucinations when exposed to higher levels of randomness.
